...
#define LINE_THRESHOLD 280           // Threshold for detecting the line
#define DEBOUNCE_DELAY_MS 100        // Debounce delay in milliseconds
#define TURN_SPEED 2000              // Motor speed for turning
...
/**
 * @brief Turns the motors to follow the line.
 * 
 ...
 * 
 * This function controls the motors to turn the robot in the specified direction 
